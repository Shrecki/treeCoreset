...
namespace kmeans {
     ...
     * @param inputPoints
     * @param k
     * @param measure Distance to use
     * @return
     */
    std::vector<Eigen::VectorXd>
    generateStartCentroids(const Eigen::VectorXd &firstCentroid, const std::vector<Point *> &inputPoints,
         ...
         * @param measure distance measure to use in kmeans
         * @return Threeple containing centroids, point assignments and total cost of this solution
         */
        Threeple *kMeans(const std::vector<Point *> &inputPoints, const std::vector<Eigen::VectorXd> *startCentroids,
     ...
     */
    std::vector<Eigen::VectorXd>
    getBestClusters(int nTries, const std::vector<Point *> &inputPoints, const unsigned int &k,
